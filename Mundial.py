...
st.title("🏆 Predictor Mundial Futbol:")



st.write(
    """
    Este modelo predice el resultado de un partido de fútbol basándose en el historial de ambos equipos hasta la fecha del encuentro establecida.
    """
)

st.image("futbol.jpg", caption="Fútbol")
